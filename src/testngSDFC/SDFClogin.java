...
public class SDFClogin {
	...
	public void Tc5_Selectusemenu_usernamedropdown() throws InterruptedException
	{
	...
	public void Tc6_Editprofile_Data() throws InterruptedException
	{
	...
	public void Tc7_usernamedropdwn()
	{
...
//alert.accept();
	...
	//selectsalesforechatter.click();
	Select sel=new Select(selectsalesforechatter);
	sel.selectByIndex(3);
	//sel.selectByValue("Salesforce Chatter");
	//Thread.sleep(4000);
...
SDFCmain.report.endTest(logger);
	...
	public void Tc10_Create_acc() throws InterruptedException
	{
	...
	public void tc11_Create_new_view() throws InterruptedException
	{
		Thread.sleep(4000);
		WebElement accuontButton=driver.findElement(By.linkText("Accounts"));
		accuontButton.click();
...
{
	//logger =report.startTest("Creating Account");
	WebElement accuontButton=driver.findElement(By.linkText("Accounts"));
	accuontButton.click();
...
public void tc13_mergeacc() throws InterruptedException
{
	Thread.sleep(4000);
	WebElement accuontButton=driver.findElement(By.linkText("Accounts"));
	accuontButton.click();
...
public void tc20_leads() throws InterruptedException
{
